package com.zgjy.gzg.widget.imageCycleView;
...
public class ImageCycleView extends LinearLayout {
     ...
     */
    public void setImageResources(ArrayList<Carousel> infoList, ImageCycleViewListener imageCycleViewListener) {
        // 清除所有子视图
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                ...
                mImageViews[i].setBackgroundResource(R.drawable.point_focured);
            }
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(R.drawable.point_nomal);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
         ...
         * 图片资源列表
         */
        private ArrayList<Carousel> mAdList = new ArrayList<Carousel>();
        ...
        public ImageCycleAdapter(Context context, ArrayList<Carousel> adList, ImageCycleViewListener imageCycleViewListener) {
            mContext = context;
            mAdList = adList;
