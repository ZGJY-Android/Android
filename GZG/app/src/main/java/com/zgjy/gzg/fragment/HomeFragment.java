...
import com.zgjy.gzg.activity.MainActivity;
import com.zgjy.gzg.util.Constant;
import com.zgjy.gzg.viewcontrollers.home.adapter.DataAdapter;
import com.zgjy.gzg.viewcontrollers.home.bean.ItemModel;
import com.zgjy.gzg.viewcontrollers.home.util.AppToast;
import com.zgjy.gzg.viewcontrollers.home.widget.SampleHeader;
...
public class HomeFragment extends BaseFragment {
    ...
    public View createView(LayoutInflater inflater, ViewGroup container, Bundle
            savedInstanceState) {
        View rootView = LayoutInflater.from(context).inflate(R.layout.fragment_home, container,
                false);
        mRecyclerView = (LRecyclerView) rootView.findViewById(R.id.mLRecyclerView);

        //init data
        ArrayList<ItemModel> dataList = new ArrayList<>();
        mHandler = new PreviewHandler(context);
        mDataAdapter = new DataAdapter(context);
        mDataAdapter.addAll(dataList);

        mLRecyclerViewAdapter = new LRecyclerViewAdapter(context, mDataAdapter);
        ...
        RecyclerViewUtils.setHeaderView(mRecyclerView, new SampleHeader(context));
        ...
        mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                AppToast.showShortText(context, item.title);
            }

            @Override
            public void onItemLongClick(View view, int position) {
                ItemModel item = mDataAdapter.getDataList().get(position);
                AppToast.showShortText(context, "onItemLongClick - " + item.title);
            }
        });
