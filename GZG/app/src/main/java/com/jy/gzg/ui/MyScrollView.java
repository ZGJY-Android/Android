...
public class MyScrollView extends ScrollView {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		Log.e("Gavin", "GavinScrollView--onInterceptTouchEvent");
		switch (ev.getAction()) {
		...
		Log.e("Gavin", "GavinScrollView--onInterceptTouchEvent return " + onIntercept);
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		Log.e("Gavin", "GavinScrollView--onTouchEvent return " + touchEvent);
		return touchEvent;
	}
