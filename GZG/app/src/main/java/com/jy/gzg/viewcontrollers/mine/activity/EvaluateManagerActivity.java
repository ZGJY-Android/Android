...
import com.jy.gzg.viewcontrollers.mine.fragment.EvaluateManagerFragment1;
import com.jy.gzg.viewcontrollers.mine.fragment.EvaluateManagerFragment2;

import java.util.ArrayList;

public class EvaluateManagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_evaluatemanager);
        initView();
        setViewListen();

        fragments = new ArrayList<>();
        fragments.add(new EvaluateManagerFragment1());// 待评价
        fragments.add(new EvaluateManagerFragment2());// 已评价
