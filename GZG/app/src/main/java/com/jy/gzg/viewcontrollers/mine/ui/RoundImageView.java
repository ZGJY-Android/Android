package com.jy.gzg.viewcontrollers.mine.ui;
...
import com.jy.gzg.viewcontrollers.mine.widget.Constant;
...
public class RoundImageView extends ImageView {
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        TypedArray a = mContext.obtainStyledAttributes(attrs, Constant.roundedimageview);
//        mBorderThickness = a.getDimensionPixelSize(Constant.roundedimageview_border_thickness, 0);
//        mBorderOutsideColor = a.getColor(Constant.roundedimageview_border_outside_color,
//                defaultColor);
//        mBorderInsideColor = a.getColor(Constant.roundedimageview_border_inside_color,
// defaultColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(roundBitmap, defaultWidth / 2 - radius, defaultHeight / 2 - radius,
                null);
    }
