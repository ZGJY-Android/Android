 ...
 */
public class JuJiaRiYongAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements View.OnClickListener {
    private Context context;
    private ArrayList<ProductBean> myzcProductBean;
    private OnRecyclerViewItemClickListener mOnItemClickListener;

    public JuJiaRiYongAdapter(ArrayList<ProductBean> myzcProductBean, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_jujiariyong,
                parent, false);
