...
import com.jy.gzg.viewcontrollers.mine.fragment.MyCouponFragment1;

import java.util.ArrayList;

public class MyCouponActivity extends AppCompatActivity {
    private String[] titles = new String[]{"待使用", "已使用", "已过期"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragments.add(new MyCouponFragment1());// 待使用
        fragments.add(new MyCouponFragment1());// 已使用
        fragments.add(new MyCouponFragment1());// 已过期
