 ...
 */
public class JianKangBaoJianAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements View.OnClickListener {
    private Context context;
    private ArrayList<ProductBean> myzcProductBean;
    private OnRecyclerViewItemClickListener mOnItemClickListener;

    public JianKangBaoJianAdapter(ArrayList<ProductBean> myzcProductBean, Context context) {
