...
/**
 * @author jiangxinxing---Gavin in English
 * 
...
public class SnapPageLayout extends ViewGroup {
	private final String TAG = "SnapPageLayout";
	private final boolean Gavin_DEBUG = true;
	...
	private Scroller mScroller;  //Gavin add view滑动的矢量， 并没有真正滑动的功能
	
	private GavinSnapPage mPageTop, mPageBottom;
	...
	public interface GavinSnapPage {
		/**
		 * 返回page根节点
		 * 
		 * @return
...
//		 DLog.i(TAG, "onLayout mDataIndex = " + mDataIndex);
	 ...
	 * @param pageBottom
	 */
	public void setSnapPages(GavinSnapPage pageTop, GavinSnapPage pageBottom) {
		mPageTop = pageTop;
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (yMoved) {
				...
				if(yDiff < 0 && mPageTop.isAtBottom() && mCurrentScreen == 0 
					...
					Log.e("Gavin", "121212121212121212121212");
		...
		case MotionEvent.ACTION_DOWN:
			...
			mLastMotionY = y;
			Log.e("Gavin", "mScroller.isFinished() is " + mScroller.isFinished());
		...
		Log.e("Gavin", "GavinSnapPageLayout---onInterceptTouchEvent return " + intercept);
		return intercept;
	}
	...
	public boolean onTouchEvent(MotionEvent ev) {
		Log.e("Gavin", "onTouchEvent--" + System.currentTimeMillis());
